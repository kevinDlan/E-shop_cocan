                        ...
                        <span class="d-flex align-items-center">
                            <a href="<?php echo e(route('product', $product->slug)); ?>" class="text-reset d-flex align-items-center flex-grow-1">
                                ...
                                <span class="minw-0 pl-2 flex-grow-1">
                                    ...
                                    <span class=""><?php echo e(single_price($cartItem['price'])); ?></span>
                                </span>
                            </a>
                            <span class="">
...
<?php /**PATH /var/www/clients/client264/web300/web/resources/views/frontend/partials/cart.blade.php ENDPATH**/ ?>
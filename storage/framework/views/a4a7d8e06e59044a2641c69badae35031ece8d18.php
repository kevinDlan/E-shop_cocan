...
<section class="py-5 text-light footer-widget" style="background-color: #44040d">
    <div class="container">
        <div class="row">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('home')); ?>" class="d-block">
                        <?php if(get_setting('footer_logo') != null): ?>
                            <img class="lazyload" src="<?php echo e(static_asset('assets/img/placeholder-rect.jpg')); ?>" data-src="<?php echo e(uploaded_asset(get_setting('footer_logo'))); ?>" alt="<?php echo e(env('APP_NAME')); ?>" height="44" width="100px">
                        <?php else: ?>
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 text-light" style="background-color: #5e0613">
    <div class="container">
...
<?php endif; ?>
<?php /**PATH /var/www/clients/client264/web300/web/resources/views/frontend/inc/footer.blade.php ENDPATH**/ ?>
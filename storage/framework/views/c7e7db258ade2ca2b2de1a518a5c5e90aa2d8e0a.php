<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="d-block text-left" <?php if(get_setting('system_logo_white') != null): ?> style="background-color: #ffffff" <?php endif; ?>>
...
<?php /**PATH /var/www/clients/client264/web300/web/resources/views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>
        ...
        <tbody>
        	...
        	<tr>
				...
				<?php if($page->type == 'home_page'): ?>
        			<td><a href="<?php echo e(route('custom-pages.show_custom_page', $page->slug)); ?>" class="text-reset"><?php echo e(translate($page->title)); ?></a></td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client264/web300/web/resources/views/backend/website_settings/pages/index.blade.php ENDPATH**/ ?>
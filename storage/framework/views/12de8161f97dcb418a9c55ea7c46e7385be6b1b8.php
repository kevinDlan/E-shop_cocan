...
<!-- Top Bar -->
<div class="top-navbar border-bottom border-soft-secondary z-1035" style="background-color:#04632b;color: white;">
    <div class="container">
        <div class="row">
    ...
    <div class="position-relative logo-bar-area z-1">
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-4 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="<?php echo e(route('home')); ?>">
                        ...
                        <?php if($header_logo != null): ?>
                            <img src="<?php echo e(uploaded_asset($header_logo)); ?>" alt="<?php echo e(env('APP_NAME')); ?>" class="mw-100 h-30px h-md-40px" height="40" width="100px">
                        <?php else: ?>
                ...
                <div class="col-2 d-none d-lg-block ml-3 mr-0">
...
<?php /**PATH /var/www/clients/client264/web300/web/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>